...
export default function ActReception({ application, equipment }) {
    console.log('ActReception props:', { application, equipment });
    ...
    return (
        ...
        >
            ...
            <Typography sx={{ mb: 2 }}>
                Арендатор вернул, а Арендодатель принял следующее оборудование:
            </Typography>
            <Table
                sx={{
            ...
            <Typography sx={{ mt: 2, fontSize: '12pt' }}>
                Примечание: Оборудование возвращено в исправном состоянии, за исключением нормального износа. Претензий у сторон нет.
            </Typography>
        </Box>
    );
}